...
import type { UniqueNFT, UniqueNFTInterface } from "../UniqueNFT";
...
export class UniqueNFT__factory {
  static readonly abi = _abi;
  static createInterface(): UniqueNFTInterface {
    return new utils.Interface(_abi) as UniqueNFTInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): UniqueNFT {
    return new Contract(address, _abi, signerOrProvider) as UniqueNFT;
  }
}
